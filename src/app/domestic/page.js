...
export default function DomesticPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      <div className="bg-gradient-to-r from-teal-700 to-teal-900 text-white py-16 px-6 relative">
        <button
          onClick={() => router.back()}
        ...
        <h1 className="text-5xl font-bold text-center">Domestic Tours</h1>
      ...
      <div className="py-20 px-6 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* You can map destinations here */}
        <div className="bg-gray-100 p-6 rounded-lg shadow hover:shadow-lg transition">
          <h2 className="text-xl font-semibold mb-2">Murree</h2>
          <p className="text-sm text-gray-600">
            A stunning hill station with snow-covered mountains and pine trees.
          </p>
        </div>
